...
function browserRedirect() {
  ...
  if (
    ...
    console.log(
      " %c Bookmarks By Bajie %c https://Bajie.cn/ ",
      "color: #d2136b; background: #c7c4ea; border-radius: 5px; padding:5px;",
      "padding:5px;"
    ),
    ...
    document.write(
      '<div id="bg" style="background-image: url(images/bgmobile.jpg)"></div>'
    );
    return "phone";
  } else {
    console.log(
      " %c Bookmarks By Bajie %c https://Bajie.cn/ ",
      "color: #ffffff; background: #6ea9e5;  border-radius: 5px; padding:5px;",
      "padding:5px;"
    ),
    ...
    document.write(
      '<div id="bg" style="background-image: url(images/bg.jpg)"></div>'
    );
    return "pc";
  }
}
