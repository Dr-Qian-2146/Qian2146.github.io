...
(function ($, window, undefined) {
  ...
  $(document).ready(function () {
    ...
    var $uim_search_form = $(
      ".user-info-menu .search-form, .nav.navbar-right .search-form"
    );
    ...
    $(".input-group.input-group-minimal:has(.form-control)").each(function (
      i,
      el
    ) {
      var $this = $(el),
      ...
      $(".form-wizard").each(function (i, el) {
        ...
        $this.bootstrapWizard({
          ...
          onTabShow: function ($tab, $navigation, index) {
            var pct =
              ($tabs.eq(index).position().left / $tabs.parent().width()) * 100;
...
function cbr_replace() {
  var $inputs = jQuery(
      'input[type="checkbox"].cbr, input[type="radio"].cbr'
    ).filter(":not(.cbr-done)"),
    $wrapper =
      '<div class="cbr-replaced"><div class="cbr-input"></div><div class="cbr-state"><span></span></div></div>';
